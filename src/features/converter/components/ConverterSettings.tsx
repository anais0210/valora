      ...
      <div className="space-y-4">
        <div>
          ...
          <select
            ...
            onChange={e =>
              handleDecimalPlacesChange(Number(e.target.value) as Settings['decimalPlaces'])
            }
        ...
        {settings.isOfflineMode && (
          <div className="text-sm text-yellow-600 bg-yellow-50 p-2 rounded border border-yellow-200">
            Le mode hors ligne utilise les derniers taux de change enregistrés. Dernière mise à jour
